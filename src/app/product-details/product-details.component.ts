...
export class ProductDetailsComponent {
  ...
  constructor(public _ActivatedRoute: ActivatedRoute, public _router: Router) {
    ...
    // this.prodDetails=this.products.filter((ele:any)=>{
    // return ele.id ==this.prodId;
    // })
  ...
  addPro(proId: any) {
    ...
    // console.log('cccccccc', this.myProduct[0]);
    ...
    if (this.myProduct.length == 0) {
     ...
     localStorage.setItem("myPr",JSON.stringify(this.myProduct))
      ...
      console.log("aaaaaaaa",this.myProduct);
      

      // console.log("otherElement");
      // console.log('cccccccc', proId);
      // for (let index = 0; index < this.myProduct.length; index++) {
      //   if (proId == this.myProduct[index]) {
      //     console.log('inloop', proId);

      //   } else {
      //     console.log('outLoop', proId);
      //     this.myProduct.push(proId);
      //     localStorage.setItem("myPr",JSON.stringify(this.myProduct))
      //   }
      // }
